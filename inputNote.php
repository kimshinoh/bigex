                                    ...
                                    <table  class="content">
                                        ...
                                        <?php
                                            ...
                                            if(!$db){
                                                ...
                                                $total_pages_sql = "SELECT COUNT(*) FROM input";
                                                $result = mysqli_query($db,$total_pages_sql);
                                                $total_rows = mysqli_fetch_array($result)[0];
                                                $total_pages = ceil($total_rows / $numPage);
                                                $select_table = "select * from input limit $offset, $numPage";
                    ...
                    <form id="form1" action="./process/Note/addNote.php" method=POST>
                        <div class="logForm" >
                            ...
                            <div class="logForm_main">
                                ...
                                <span class="logForm_title">Mã phiếu :</span>
                                    <input id="Id" name="Id" type="text" class="logForm_input" placeholder="Vd: 01" required>
                                    <span class="formMessage"></span>
                                </div>
                                <div class="form-group">
                                <span class="logForm_title">Ngày nhập :</span>
                                    <input id="DateInput" name="DateInput" type="datetime-local" class="logForm_input" required>
                                    <span class="formMessage"></span>
                                </div>
                            </div>
                        </div>
