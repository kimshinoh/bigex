                                    ...
                                    <table  class="content">
                                        ...
                                        <?php
                                            ...
                                            if(!$db){
                                                ...
                                                $select_table = 'select * from output';
                                                ...
                                                if(mysqli_num_rows($value)>0){
                                                    ...
                                                    while($r=mysqli_fetch_array($value)){
                                                        ...
                                                        echo "<td><a class='tool' href='/process/Note/deleteNoteOut.php?Id=$id'><i class='far fa-trash-alt'></i></a><a class='tool' href='/outputInven.php?IdNote=$id'><i class='fas fa-search'></i></a></td>";
                                                        echo '</tr>';
        ...
        <div class="modal_body">
            <div id="add" class="modal_innerAdd">
                <div class="logForm_container">
                    <form id="form1" action="./process/Note/addNoteOut.php" method=POST>
                        <div class="logForm" >
